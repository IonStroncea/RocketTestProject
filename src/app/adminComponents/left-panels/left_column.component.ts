...
@Component({
    ...
    <div class=leftColumnContainer>\
        <h1>Hi {{name}},</h1>\
        <h1>Welcome back!</h1>\
        <p>This page is designed to give some important information about the application. Lets make someting together!</p>\
    ...
    styles:'.view-propile{ align-items: center;   text-align: center;display: flex; background-color:white; border-radius:16px }\
