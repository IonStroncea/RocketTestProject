...
@Component({
    ...
    styles:'.panel{width:100%; background-color:white; border-radius:16px; margin-bottom:15px; display:flex;align-items: center;  justify-content: center;}\
    ...
    .icon svg{width:40px;height:40px; border-radius:50%}\
