...
@Component({
    ...
    <svg class="right-sign" focusable="false" viewBox="0 0 24 24" aria-hidden="true" data-testid="ArrowRightIcon"><path class="path-grey" d="m10 17 5-5-5-5v10z"></path></svg>\
    </div>',
    ...
    .path-grey{fill:rgb(189,189,189)}\
    '
})
